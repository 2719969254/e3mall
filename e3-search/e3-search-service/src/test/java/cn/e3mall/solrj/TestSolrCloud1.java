...
public class TestSolrCloud1 {
	...
	public static void main(String[] args) throws IOException {
		...
		CloudSolrClient cloudSolrClient = getCloudSolrClient("192.168.25.132");
		...
		//创建索引
		TestSolrCloud1.addIndex(cloudSolrClient);
		//查询
		TestSolrCloud1.search(cloudSolrClient, "context:李四");
